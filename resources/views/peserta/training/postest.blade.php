                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Training {{ $schedule->training->nama_training }} - Postest
                            <span class="tools pull-right">
                              <a href="javascript:;" class="fa fa-chevron-down"></a>
                             </span>
                        </header>
                        <div class="panel-body">
                            <form role="form" method="POST" action="{{ route('h.training.postest.update', $schedule->id) }}">
                                <input type="hidden" value="{{ $schedule->id }}" name="schedule_id">
                                <input type="hidden" value="{{ $schedule->training_hasil->pluck('id')->first() }}" name="soal_peserta_id">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <div class="title pull-right">
                                            <h5 class="text-danger">Klik Submit untuk menyimpan jawaban anda dan lakukan pengisian evaluasi training !!</h5>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="pull-left">
